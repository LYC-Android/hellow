 ...
 */
public class SendTextHolderBmob extends Bmob_BaseViewHolder {
    ...
    public SendTextHolderBmob(Context context, ViewGroup root, BmobIMConversation c, Bmob_ChatAdapter.OnRecyclerViewListener listener) {
        super(context, root, R.layout.item_chat_sent_message,listener);
        this.c = c;
    }

    @Override
    public void setMesaage(final BmobIMMessage message) {
