...
public class Bmob_NewRecordPlayClickListener implements View.OnClickListener {
	...
	public static Bmob_NewRecordPlayClickListener currentPlayListener = null;
	static BmobIMAudioMessage currentMsg = null;

	public Bmob_NewRecordPlayClickListener(Context context, BmobIMAudioMessage msg, ImageView voice) {
		this.iv_voice = voice;
		this.message = msg;
