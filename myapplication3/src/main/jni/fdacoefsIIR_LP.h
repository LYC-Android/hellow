 ...
 */
#define MWSPT_NSEC 9
const int lp_NL[MWSPT_NSEC] = { 1,3,1,3,1,3,1,3,1 };
const double lp_NUM[MWSPT_NSEC][3] = {//要手工改成double型
  {
...
const int lp_DL[MWSPT_NSEC] = { 1,3,1,3,1,3,1,3,1 };
const double lp_DEN[MWSPT_NSEC][3] = {//要手工改成double型
  {
                   1,                 0,                 0 
  },
  {
